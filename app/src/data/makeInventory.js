...
export const MAKE_INVENTORY = Object.freeze([
  ...
  { id: 6323457, nombre: "⚖️ Solicitud GDPR Acceso u Olvido de Datos", categoria: C.EVENT_TRIGGERED, activo: true, scheduling: "webhook (immediately)", ejecuciones: 2, operaciones: 2, errores: 0, ultimaModificacion: "2026-08-21T00:00:00.000Z", usaAirtable: true, nota: "GDPR_ACCESO (EJECUTADO) y GDPR_OLVIDO (REQUIERE_REVISION_HUMANA) verificados E2E 2026-08-21. Worker integrado con MAKE_GDPR_WEBHOOK + AIRTABLE_GDPR_TABLE_ID.", estadoVerificacion: "verificado_e2e" },
