...
// cifras a mano en ningún panel (PLAYER/STAFF/ADMIN/SUPPORT). "conectados"
// = todo lo que no es NO_CONECTADO ni NO_APLICA (incluye BLOQUEADO: un flujo
// bloqueado por Airtable sigue estando integrado en la app, solo que su
// dependencia externa no responde hoy). "probados" incluye PROBADO_PARCIAL
// (evidencia real pero no E2E completo) además de OPERATIVO. "operativos"
// exige evidencia E2E objetiva (idéntico a `probadoE2E` de la matriz de
// arquitectura) — nunca declarar 50/50 operativos sin esa evidencia.
