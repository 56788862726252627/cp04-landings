...
export const tutorialSteps = {
  PLAYER: [
    ...
    { step: 4, title: "Torneos", text: "Aquí puedes consultar el torneo del club: parejas, cruces y resultados.", selector: "[data-tour='sidebar-torneos']", targetModule: "torneos" },
  ...
  STAFF: [
    ...
    { step: 5, title: "Torneos", text: "Desde aquí puedes crear y gestionar el torneo del club: parejas, cruces y resultados.", selector: "[data-tour='sidebar-torneos']", targetModule: "torneos" },
  ...
  ADMIN: [
    ...
    { step: 5, title: "Torneos y Ranking", text: "Controla actividad competitiva, torneos y comunidad.", selector: "[data-tour='sidebar-torneos']", targetModule: "torneos" },
