...
export const MAKE_APP_INTEGRATION_MAP = Object.freeze([
  ...
  { id: 6217724, nombre: "🔄 Backup Semanal", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "ninguno de Airtable; disparador de app no detectado; UI preparada (Paso 07O) sin Worker/endpoint real, validación real pendiente por Airtable 429" },
  ...
  { id: 5736472, nombre: "🚨 Alerta Pistas Libres + Flash Promo", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "Airtable 429 (cuota agotada); UI preparada (Paso 07O) sin Worker/endpoint real" },
  { id: 5736800, nombre: "📋 Dashboard Ejecutivo Diario", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "ninguno de Airtable; disparador de app no detectado; UI preparada (Paso 07O) sin Worker/endpoint real, validación real pendiente por Airtable 429" },
  { id: 5736468, nombre: "📊 Panel KPI Semanal", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "ninguno de Airtable; disparador de app no detectado; UI preparada (Paso 07O) sin Worker/endpoint real, validación real pendiente por Airtable 429" },
  ...
  { id: 5811901, nombre: "📊 Análisis NPS Semanal", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "ninguno de Airtable; disparador de app no detectado; UI preparada (Paso 07O) sin Worker/endpoint real, validación real pendiente por Airtable 429" },
  ...
  { id: 5791119, nombre: "📊 Informe Mensual", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "Airtable 429 (cuota agotada); UI preparada (Paso 07O) sin Worker/endpoint real" },
  ...
  { id: 4942506, nombre: "🔔 Recordatorio 24h Antes", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "Airtable 429 (cuota agotada); UI preparada (Paso 07O) sin Worker/endpoint real" },
  { id: 5736463, nombre: "⚡ Recordatorio 2h Antes", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "Airtable 429 (cuota agotada); UI preparada (Paso 07O) sin Worker/endpoint real" },
  { id: 5736797, nombre: "🚫 Seguimiento No-Show", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "Airtable 429 (cuota agotada); UI preparada (Paso 07O) sin Worker/endpoint real" },
  { id: 5791113, nombre: "📋 Gestión Lista de Espera", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "UI preparada (sidebar + módulo visual) sin Worker/endpoint real; Make sigue ejecutando este escenario solo cada hora; validación real pendiente por Airtable 429 (PASO 07N, 2026-07-20)" },
  ...
  { id: 5791133, nombre: "🏟️ Cierre Temporal de Pistas", grupo: "A", integradoEnApp: true, integradoEnWorker: true, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "MAKE_CIERRE_TEMPORAL_PISTA_WEBHOOK no configurado (código Worker completo, 16 tests verdes); sin probar contra Make/Airtable real, no confirmado end-to-end (PASO 07E, 2026-07-19)" },
  ...
  { id: 5291559, nombre: "🔐 Control Acceso QR", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "ninguno de Airtable; disparador de app no detectado; UI preparada (Paso 07O) sin Worker/endpoint real, validación real pendiente por Airtable 429" },
  { id: 6244975, nombre: "🔑 Generación QR Acceso", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "ninguno (verificado por Make, no por app); UI preparada (Paso 07O) sin Worker/endpoint real, validación real pendiente por Airtable 429" },
  ...
  { id: 6323457, nombre: "⚖️ Solicitud GDPR Acceso u Olvido de Datos", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "accion manual pendiente dentro de Make; UI preparada (Paso 07O) sin Worker/endpoint real, validación real pendiente por Airtable 429" },
  { id: 6323450, nombre: "🛡️ Alerta Seguridad Acceso Sospechoso", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "Airtable 429 (cuota agotada); UI preparada (Paso 07O) sin Worker/endpoint real" },
  ...
  { id: 6216523, nombre: "🗂️ Backup Plantilla Drive", grupo: "B", integradoEnApp: true, integradoEnWorker: false, soloInventariado: false, requiereMakeManual: true, bloqueadorPrincipal: "ninguno detectado; UI preparada (Paso 07O) sin Worker/endpoint real, validación real pendiente por Airtable 429" },
]);
