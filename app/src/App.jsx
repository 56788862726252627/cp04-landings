...
const DEMO_MAKE_EJECUCIONES_24H = [42, 55, 38, 61, 47, 53, 49, 66, 71, 58, 44, 39, 52, 48, 57, 63, 70, 65, 59, 42, 38, 44, 51, 48];

const DEMO_MAKE_CATEGORIAS = [
  { l:"Reservas", v:9, c:"#2f6bff" },
  { l:"Jugadores", v:6, c:"#20e3b2" },
  { l:"Backups", v:4, c:"#b6ff00" },
  { l:"Alertas", v:5, c:"#ffad47" },
  { l:"Analítica", v:4, c:"#a78bfa" },
  { l:"CRM", v:4, c:"#fb7185" },
  { l:"Torneos", v:3, c:"#f59e0b" },
  { l:"Pagos", v:3, c:"#34d399" },
  { l:"Soporte", v:3, c:"#60a5fa" },
  { l:"Reportes", v:2, c:"#f472b6" },
];

const DEMO_MAKE_FLUJOS_TOP = [
  { l:"API Reservas", v:892, c:"#2f6bff" },
  { l:"Alta Jugador", v:634, c:"#20e3b2" },
  { l:"Alerta Pistas", v:521, c:"#b6ff00" },
  { l:"Backup Semanal", v:48, c:"#ffad47" },
  { l:"NPS Semanal", v:44, c:"#a78bfa" },
];

const DEMO_MAKE_FLUJOS_ERRORES = [
  { l:"Recordatorio Pago", v:3, c:"#ff5e3a" },
  { l:"Sincronización Cal.", v:2, c:"#ffad47" },
  { l:"Export Torneos", v:1, c:"#ffad47" },
];

const WORKFLOW_ITEMS = [
  {
    "id": 1,
    "nombre": "🚨 Alerta Pistas Libres + Flash Promo · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "🚨 Alerta Pistas Libres + Flash Promo · Club Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Retención",
    "entrada": "App",
    "funcion": "Detecta huecos libres y prepara alertas o promociones flash.",
    "blueprint": "workflows/27-alerta-pistas-libres-flash-promo/final/Alerta_Pistas_Libres_Flash_Promo_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5736472",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  },
  {
    "id": 2,
    "nombre": "🎾 Alta de Jugador · Club Pádel 04 · CORREGIDO FINAL",
    "nombre_final": "🎾 Alta de Jugador · Club Pádel 04 · CORREGIDO FINAL",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Jugadores",
    "entrada": "App",
    "funcion": "Registra nuevos jugadores y envía confirmación.",
    "blueprint": "workflows/02-alta-jugador/final/Alta_de_Jugador_Club_Padel_04_CORREGIDO_FINAL.blueprint.json",
    "make_id": "6199248",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 3,
    "nombre": "📊 Análisis NPS Semanal Encuestas · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "📊 Análisis NPS Semanal Encuestas · Club Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Analítica",
    "entrada": "App",
    "funcion": "Automatización conectada.",
    "blueprint": "workflows/03-analisis-nps-semanal-encuestas-club-padel-04-definitivo/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5811901",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 4,
    "nombre": "📡 API Reservas Club Pádel 04 · FINAL V2 · Crear + Cancelar + Ocupación",
    "nombre_final": "📡 API Reservas Club Pádel 04 · FINAL V2 · Crear + Cancelar + Ocupación",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Reservas",
    "entrada": "App",
    "funcion": "Gestiona reservas desde la app.",
    "blueprint": "workflows/01-api-reservas/final/API_Reservas_Club_Padel_04_FINAL_V2_Crear_Cancelar_Ocupacion.blueprint.json",
    "make_id": "5697630",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 5,
    "nombre": "Backup_Semanal_Datos_Club_Padel_04_CORREGIDO",
    "nombre_final": "Backup_Semanal_Datos_Club_Padel_04_CORREGIDO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Backups",
    "entrada": "App",
    "funcion": "Backup semanal de reservas y socios.",
    "blueprint": "workflows/04-backup-semanal-datos/final/Backup_Semanal_Datos_Club_Padel_04_CORREGIDO.blueprint.json",
    "make_id": "6217724",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 6,
    "nombre": "❌ Baja de Jugador + Promoción Automática · Pádel 04 · DEFINITIVO",
    "nombre_final": "❌ Baja de Jugador + Promoción Automática · Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Jugadores",
    "entrada": "App",
    "funcion": "Gestiona baja de jugador y activa promoción automática si corresponde.",
    "blueprint": "workflows/20-baja-jugador-promocion-automatica/final/Baja_de_Jugador_Promocion_Automatica_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5288809",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 7,
    "nombre": "🎁 Bienvenida Nuevo Socio · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "🎁 Bienvenida Nuevo Socio · Club Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Jugadores",
    "entrada": "App",
    "funcion": "Automatización conectada.",
    "blueprint": "workflows/07-bienvenida-nuevo-socio-club-padel-04-definitivo/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5791022",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 8,
    "nombre": "💬 Chatbot Web Reservas Sin Tally · Pádel 04",
    "nombre_final": "💬 Chatbot Web Reservas Sin Tally · Pádel 04",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Reservas",
    "entrada": "App",
    "funcion": "Automatización conectada.",
    "blueprint": "workflows/08-chatbot-web-reservas-sin-tally-padel-04/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5799061",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 9,
    "nombre": "🏟️ Cierre Temporal de Pistas · Pádel 04 · DEFINITIVO",
    "nombre_final": "🏟️ Cierre Temporal de Pistas · Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Reservas",
    "entrada": "App",
    "funcion": "Bloquea pistas temporalmente por mantenimiento, clima u otras incidencias.",
    "blueprint": "workflows/19-cierre-temporal-pistas/final/Cierre_Temporal_de_Pistas_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5791133",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 10,
    "nombre": "🏷️ Confirmación Inscripción Torneo · Pádel 04 · DEFINITIVO",
    "nombre_final": "🏷️ Confirmación Inscripción Torneo · Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Torneos y Liga",
    "entrada": "App",
    "funcion": "Confirma inscripciones de jugadores a torneos y envía email.",
    "blueprint": "workflows/23-confirmacion-inscripcion-torneo/final/Confirmacion_Inscripcion_Torneo_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5791116",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 11,
    "nombre": "❄️ Congelación + Reactivación Membresía · Pádel 04 · DEFINITIVO",
    "nombre_final": "❄️ Congelación + Reactivación Membresía · Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Automatizaciones",
    "entrada": "App",
    "funcion": "Automatización conectada.",
    "blueprint": "workflows/11-congelacion-reactivacion-membresia-padel-04-definitivo/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5812456",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 12,
    "nombre": "🔐 Control Acceso QR · Pádel 04",
    "nombre_final": "🔐 Control Acceso QR · Pádel 04",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Acceso",
    "entrada": "App",
    "funcion": "Valida códigos QR de acceso y registra accesos permitidos o denegados.",
    "blueprint": "workflows/07-control-acceso-qr/final/Control_Acceso_QR_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5291559",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 13,
    "nombre": "🏆 Cruces de Torneo · Pádel 04 · DEFINITIVO",
    "nombre_final": "🏆 Cruces de Torneo · Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Torneos y Liga",
    "entrada": "App",
    "funcion": "Gestiona cruces de torneo y resultados de partidos.",
    "blueprint": "workflows/24-cruces-de-torneo/final/Cruces_de_Torneo_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "4919937",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 14,
    "nombre": "📋 Dashboard Ejecutivo Diario · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "📋 Dashboard Ejecutivo Diario · Club Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Analítica e IA",
    "entrada": "App",
    "funcion": "Genera resumen ejecutivo diario con actividad, ocupación y métricas.",
    "blueprint": "workflows/28-dashboard-ejecutivo-diario/final/Dashboard_Ejecutivo_Diario_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5736800",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 15,
    "nombre": "👥 Emparejamiento Jugadores Sin Pareja · Pádel 04 · DEFINITIVO",
    "nombre_final": "👥 Emparejamiento Jugadores Sin Pareja · Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Torneos y Liga",
    "entrada": "App",
    "funcion": "Detecta jugadores sin pareja y propone emparejamientos adecuados.",
    "blueprint": "workflows/26-emparejamiento-jugadores-sin-pareja/final/Emparejamiento_Jugadores_Sin_Pareja_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5791128",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 16,
    "nombre": "💸 Escalado Impagos 3 Etapas · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "💸 Escalado Impagos 3 Etapas · Club Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Facturación",
    "entrada": "App",
    "funcion": "Automatización conectada.",
    "blueprint": "workflows/16-escalado-impagos-3-etapas-club-padel-04-definitivo/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5811888",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 17,
    "nombre": "🎂 Felicitación Cumpleaños · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "🎂 Felicitación Cumpleaños · Club Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Jugadores",
    "entrada": "App",
    "funcion": "Automatización conectada.",
    "blueprint": "workflows/17-felicitacion-cumpleanos-club-padel-04-definitivo/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5811864",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 18,
    "nombre": "🔑 Generación QR Acceso · Reserva Confirmada · Club Pádel 04 · CANDIDATO",
    "nombre_final": "🔑 Generación QR Acceso · Reserva Confirmada · Club Pádel 04 · CANDIDATO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Acceso",
    "entrada": "App",
    "funcion": "Genera QR de acceso para reserva confirmada, envía email y actualiza Airtable.",
    "blueprint": "workflows/06-generacion-qr-acceso/final/Generacion_QR_Acceso_Reserva_Confirmada_Club_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "6244975",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 19,
    "nombre": "📋 Gestión Lista de Espera Reservas · Pádel 04 · DEFINITIVO",
    "nombre_final": "📋 Gestión Lista de Espera Reservas · Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Reservas",
    "entrada": "App",
    "funcion": "Gestiona lista de espera y promociona jugadores cuando queda una pista libre.",
    "blueprint": "workflows/18-gestion-lista-espera-reservas/final/Gestion_Lista_de_Espera_Reservas_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5791113",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 20,
    "nombre": "📊 Informe Mensual de Actividad · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "📊 Informe Mensual de Actividad · Club Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Analítica",
    "entrada": "App",
    "funcion": "Automatización conectada.",
    "blueprint": "workflows/20-informe-mensual-de-actividad-club-padel-04-definitivo/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5791119",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 21,
    "nombre": "🗺️ Mapa de Flujos + Auditoría Make · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "🗺️ Mapa de Flujos + Auditoría Make · Club Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Auditoría",
    "entrada": "App",
    "funcion": "Registra y audita el mapa de flujos Make de Club Pádel 04.",
    "blueprint": "workflows/05-mapa-flujos-auditoria-make/final/Mapa_de_Flujos_Auditoria_Make_Club_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "6233755",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 22,
    "nombre": "📧 Monitor Prueba Gratuita Gmail · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "📧 Monitor Prueba Gratuita Gmail · Club Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Retención",
    "entrada": "App",
    "funcion": "Monitoriza pruebas gratuitas activas y envía aviso interno por Gmail.",
    "blueprint": "workflows/21-monitor-prueba-gratuita-gmail/final/Monitor_Prueba_Gratuita_Gmail_Club_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5750308",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 23,
    "nombre": "🔁 Onboarding Secuencial Nuevo Socio · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "🔁 Onboarding Secuencial Nuevo Socio · Club Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Retención",
    "entrada": "App",
    "funcion": "Envía comunicaciones secuenciales de onboarding a nuevos socios.",
    "blueprint": "workflows/22-onboarding-secuencial-nuevo-socio/final/Onboarding_Secuencial_Nuevo_Socio_Club_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5811918",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 24,
    "nombre": "📊 Panel KPI Semanal · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "📊 Panel KPI Semanal · Club Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Analítica e IA",
    "entrada": "App",
    "funcion": "Calcula KPIs semanales, genera análisis con IA y envía informe por Gmail.",
    "blueprint": "workflows/29-panel-kpi-semanal/final/Panel_KPI_Semanal_Club_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5736468",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 25,
    "nombre": "PLANTILLA Google Drive · Backup CP04",
    "nombre_final": "PLANTILLA Google Drive · Backup CP04",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Soporte Técnico",
    "entrada": "App",
    "funcion": "Automatización conectada.",
    "blueprint": "workflows/25-plantilla-google-drive-backup-cp04/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "6216523",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 26,
    "nombre": "📈 Predicción Ocupación + Precios Dinámicos · Pádel 04 · DEFINITIVO",
    "nombre_final": "📈 Predicción Ocupación + Precios Dinámicos · Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Analítica",
    "entrada": "App",
    "funcion": "Automatización conectada.",
    "blueprint": "workflows/26-prediccion-ocupacion-precios-dinamicos-padel-04-definitivo/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5799041",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 27,
    "nombre": "🎁 Programa de Referidos · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "🎁 Programa de Referidos · Club Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Jugadores",
    "entrada": "App",
    "funcion": "Automatización conectada.",
    "blueprint": "workflows/27-programa-de-referidos-club-padel-04-definitivo/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5812297",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 28,
    "nombre": "🔁 Reactivación Clientes Inactivos 30d · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "🔁 Reactivación Clientes Inactivos 30d · Club Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Jugadores",
    "entrada": "App",
    "funcion": "Automatización conectada.",
    "blueprint": "workflows/28-reactivacion-clientes-inactivos-30d-club-padel-04-definitivo/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5736470",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 29,
    "nombre": "🔔 Recordatorio Automático 24h Antes · Pádel 04 · DEFINITIVO",
    "nombre_final": "🔔 Recordatorio Automático 24h Antes · Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Recordatorios",
    "entrada": "App",
    "funcion": "Envía recordatorio automático 24 horas antes de la reserva.",
    "blueprint": "workflows/15-recordatorio-24h/final/Recordatorio_Automatico_24h_Antes_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "4942506",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 30,
    "nombre": "🏅 Resultados y Clasificación por Parejas · Pádel 04 · DEFINITIVO",
    "nombre_final": "🏅 Resultados y Clasificación por Parejas · Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Torneos y Liga",
    "entrada": "App",
    "funcion": "Actualiza resultados y clasificación por parejas.",
    "blueprint": "workflows/25-resultados-clasificacion-parejas/final/Resultados_y_Clasificacion_por_Parejas_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5330078",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 31,
    "nombre": "🏆 Reto 04 + Puntos y Recompensas · Pádel 04 · DEFINITIVO",
    "nombre_final": "🏆 Reto 04 + Puntos y Recompensas · Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Gamificación",
    "entrada": "App",
    "funcion": "Suma puntos, registra logros y envía recompensas.",
    "blueprint": "workflows/12-reto-04-puntos-recompensas/final/Reto_04_Puntos_y_Recompensas_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5791374",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 32,
    "nombre": "🚫 Seguimiento No-Show · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "🚫 Seguimiento No-Show · Club Pádel 04 · DEFINITIVO",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Retención",
    "entrada": "App",
    "funcion": "Detecta ausencias, registra no-shows y prepara seguimiento del jugador.",
    "blueprint": "workflows/17-seguimiento-no-show/final/Seguimiento_No_Show_Club_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5736797",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 33,
    "nombre": "🗓️ Sincronización Multi-Calendario · Pádel 04",
    "nombre_final": "🗓️ Sincronización Multi-Calendario · Pádel 04",
    "estado": "ACTIVO",
    "porcentaje": 100,
    "categoria": "Reservas",
    "entrada": "App",
    "funcion": "Sincroniza reservas confirmadas con Google Calendar y Airtable.",
    "blueprint": "workflows/08-sincronizacion-multi-calendario/final/Sincronizacion_Multi_Calendario_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5735907",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": true
  ...
  {
    "id": 34,
    "nombre": "⚠️ Alerta Crítica Fallos Make · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "⚠️ Alerta Crítica Fallos Make · Club Pádel 04 · DEFINITIVO",
    "estado": "APAGADO",
    "porcentaje": 100,
    "categoria": "Soporte Técnico",
    "entrada": "App",
    "funcion": "Recibe incidencias críticas de Make y avisa al administrador.",
    "blueprint": "workflows/03-alerta-critica-fallos-make/final/Alerta_Critica_Fallos_Make_Club_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "6192096",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": false
  ...
  {
    "id": 35,
    "nombre": "🎧 Atención Socio 24·7 WhatsApp FAQ · Pádel 04",
    "nombre_final": "🎧 Atención Socio 24·7 WhatsApp FAQ · Pádel 04",
    "estado": "APAGADO",
    "porcentaje": 100,
    "categoria": "Jugadores",
    "entrada": "App",
    "funcion": "Escenario oficial actual de Make (apagado) conectado al Centro técnico de Club Pádel 04.",
    "blueprint": "workflows/35-atencion-socio-24-7-whatsapp-faq-padel-04/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5799031",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": false
  ...
  {
    "id": 36,
    "nombre": "🤖 Bot IA Reservas · Telegram · Pádel 04 · DEFINITIVO",
    "nombre_final": "🤖 Bot IA Reservas · Telegram · Pádel 04 · DEFINITIVO",
    "estado": "APAGADO",
    "porcentaje": 100,
    "categoria": "Reservas",
    "entrada": "App",
    "funcion": "Escenario oficial actual de Make (apagado) conectado al Centro técnico de Club Pádel 04.",
    "blueprint": "workflows/36-bot-ia-reservas-telegram-padel-04-definitivo/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "4832095",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": false
  ...
  {
    "id": 37,
    "nombre": "🤖 Bot IA Reservas · WhatsApp · Pádel 04 · DEFINITIVO",
    "nombre_final": "🤖 Bot IA Reservas · WhatsApp · Pádel 04 · DEFINITIVO",
    "estado": "APAGADO",
    "porcentaje": 100,
    "categoria": "Reservas",
    "entrada": "App",
    "funcion": "Escenario oficial actual de Make (apagado) conectado al Centro técnico de Club Pádel 04.",
    "blueprint": "workflows/37-bot-ia-reservas-whatsapp-padel-04-definitivo/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5798996",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": false
  ...
  {
    "id": 38,
    "nombre": "🎯 Campaña Flash Segmentada WhatsApp · Pádel 04",
    "nombre_final": "🎯 Campaña Flash Segmentada WhatsApp · Pádel 04",
    "estado": "APAGADO",
    "porcentaje": 100,
    "categoria": "Comunicación",
    "entrada": "App",
    "funcion": "Escenario oficial actual de Make (apagado) conectado al Centro técnico de Club Pádel 04.",
    "blueprint": "workflows/38-campana-flash-segmentada-whatsapp-padel-04/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5791124",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": false
  ...
  {
    "id": 39,
    "nombre": "⭐ Encuesta Post-Partido + Reseña Google · Pádel 04 · DEFINITIVO",
    "nombre_final": "⭐ Encuesta Post-Partido + Reseña Google · Pádel 04 · DEFINITIVO",
    "estado": "APAGADO",
    "porcentaje": 100,
    "categoria": "Automatizaciones",
    "entrada": "App",
    "funcion": "Escenario oficial actual de Make (apagado) conectado al Centro técnico de Club Pádel 04.",
    "blueprint": "workflows/39-encuesta-post-partido-resena-google-padel-04-definitivo/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5736466",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": false
  ...
  {
    "id": 40,
    "nombre": "💰 Facturación y Cobro Automático · Pádel 04",
    "nombre_final": "💰 Facturación y Cobro Automático · Pádel 04",
    "estado": "APAGADO",
    "porcentaje": 100,
    "categoria": "Facturación",
    "entrada": "App",
    "funcion": "Escenario oficial actual de Make (apagado) conectado al Centro técnico de Club Pádel 04.",
    "blueprint": "workflows/40-facturacion-y-cobro-automatico-padel-04/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5733370",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": false
  ...
  {
    "id": 41,
    "nombre": "⚡ Recordatorio 2h Antes · Club Pádel 04 · DEFINITIVO",
    "nombre_final": "⚡ Recordatorio 2h Antes · Club Pádel 04 · DEFINITIVO",
    "estado": "APAGADO",
    "porcentaje": 100,
    "categoria": "Recordatorios",
    "entrada": "App",
    "funcion": "Envía recordatorio automático 2 horas antes de la reserva.",
    "blueprint": "workflows/16-recordatorio-2h/final/Recordatorio_2h_Antes_Club_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5736463",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": false
  ...
  {
    "id": 42,
    "nombre": "💳 Recordatorio Cuota Mensual · Club Pádel 04",
    "nombre_final": "💳 Recordatorio Cuota Mensual · Club Pádel 04",
    "estado": "APAGADO",
    "porcentaje": 100,
    "categoria": "Facturación",
    "entrada": "App",
    "funcion": "Escenario oficial actual de Make (apagado) conectado al Centro técnico de Club Pádel 04.",
    "blueprint": "workflows/42-recordatorio-cuota-mensual-club-padel-04/final/PENDIENTE_SINCRONIZAR_BLUEPRINT.json",
    "make_id": "5791032",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": false
  ...
  {
    "id": 43,
    "nombre": "📝 Tally → API Reservas · Pádel 04",
    "nombre_final": "📝 Tally → API Reservas · Pádel 04",
    "estado": "APAGADO",
    "porcentaje": 100,
    "categoria": "Reservas",
    "entrada": "App",
    "funcion": "Flujo heredado para transición Tally hacia API de reservas.",
    "blueprint": "workflows/14-tally-api-reservas/final/Tally_API_Reservas_Padel_04_DEFINITIVO.blueprint.json",
    "make_id": "5747703",
    "make_team_id": "1099976",
    "make_folder_id": "316391",
    "make_active": false
...
function FlujosMake() {
  ...
  const cats = ["Todas", ...Array.from(new Set(DEMO_MAKE_CATEGORIAS.map(c => c.l)))];
  const filtered = showTable
    ? (catFilter === "Todas" ? WORKFLOW_ITEMS : WORKFLOW_ITEMS.filter(f => f.categoria === catFilter))
    : [];

  const exportMakeJSON = () => {
    const blob = new Blob([JSON.stringify({ total: 43, activos: kpi.makeActivos, errores: kpi.makeErrores, pausados: kpi.makePausados, tasaExito: kpi.tasaExitoMake, flujos: WORKFLOW_ITEMS, fuente: "demo", nota: "TODO producción: alimentar desde backend/proxy seguro" }, null, 2)], { type: "application/json" });
    const url = URL.createObjectURL(blob);
    const a = document.createElement("a"); a.href = url; a.download = `make-status-${Date.now()}.json`; a.click();
    URL.revokeObjectURL(url);
  };

  return (
    <section style={{ padding: "clamp(18px,3vw,42px) 24px", maxWidth: 1220, margin: "0 auto" }}>
      {/* Nota TODO producción */}
      {/* TODO producción: alimentar este dashboard desde backend/proxy seguro (Make API o webhook propio). NUNCA llamar Make API con clave privada desde el frontend. */}

      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", flexWrap:"wrap", gap:16, marginBottom:24 }}>
        <SectionTitle eyebrow={tx("flujos.title")} title={tx("flujos.title")} desc={tx("flujos.desc")} />
        <div style={{ display:"flex", gap:8, flexWrap:"wrap", alignItems:"center" }}>
          <button type="button" onClick={exportMakeJSON} style={{ border:`1px solid rgba(182,255,0,.35)`, background:"none", color:T.accent, borderRadius:10, padding:"7px 14px", cursor:"pointer", fontWeight:700, fontSize:".8rem" }}>{tx("flujos.exportar_json")}</button>
        </div>
      </div>

      {/* KPI STRIP */}
      <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(150px,1fr))", gap:10, marginBottom:18 }}>
        <MetricCard label={tx("flujos.total_procesos")} value="43/43" sub={tx("flujos.auditados")} icon="⚡" />
        <MetricCard label={tx("flujos.activos_label")} value={kpi.makeActivos} sub={tx("flujos.conectados")} trend={null} color={T.accent} icon="✅" />
        <MetricCard label={tx("flujos.pausados_label")} value={kpi.makePausados} sub={tx("flujos.en_pausa")} trend={null} color={T.warning} icon="⏸" />
        <MetricCard label={tx("flujos.incidencias_label")} value={kpi.makeErrores} sub={tx("flujos.ultimas_24h")} trend={null} color={kpi.makeErrores > 0 ? T.danger : T.accent} icon="🔴" />
        <MetricCard label={tx("flujos.tasa_exito")} value={kpi.tasaExitoMake+"%"} sub={tx("flujos.global_sistema")} trend={null} color={T.accent2} icon="📈" />
        <MetricCard label={tx("flujos.ultimo_backup")} value={kpi.ultimoBackup} sub={tx("flujos.automatico")} trend={null} color="#a78bfa" icon="💾" />
      </div>

      {/* GRÁFICAS MAKE */}
      <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(min(100%,300px),1fr))", gap:16, marginBottom:20 }}>
        <ChartCard title={tx("flujos.estado_procesos_label")} sub={tx("flujos.por_estado")}>
          <DonutChart size={110} label="43 procesos" segments={[
            { l:tx("flujos.activos_label"), v:kpi.makeActivos,  c:T.accent },
            { l:tx("flujos.pausados_label"), v:kpi.makePausados, c:T.warning },
            { l:tx("flujos.incidencias_label"), v:kpi.makeErrores, c:T.danger },
          ]} />
        </ChartCard>

        <ChartCard title={tx("flujos.actividad_24h")} sub={tx("flujos.por_hora")}>
          <MiniLineChart data={DEMO_MAKE_EJECUCIONES_24H} height={80} color={T.accent} />
          <div style={{ display:"flex", justifyContent:"space-between", marginTop:6 }}>
            {["0h","6h","12h","18h","23h"].map(h => <span key={h} style={{ color:T.textDim, fontSize:".62rem" }}>{h}</span>)}
          </div>
          <div style={{ color:T.textDim, fontSize:".72rem", marginTop:6 }}>
            {tx("flujos.total_24h_label")}: <strong style={{ color:T.accent }}>{DEMO_MAKE_EJECUCIONES_24H.reduce((a,b)=>a+b,0)}</strong> {tx("flujos.ejecuciones")}
          </div>
        </ChartCard>

        <ChartCard title={tx("flujos.por_categoria")} sub={tx("flujos.distribucion")}>
          <HorizontalBarChart data={DEMO_MAKE_CATEGORIAS.slice(0,6)} />
        </ChartCard>
      </div>

      <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(min(100%,300px),1fr))", gap:16, marginBottom:24 }}>
        <ChartCard title={tx("flujos.mas_activos")} sub={tx("flujos.actividad_24h")}>
          <HorizontalBarChart data={DEMO_MAKE_FLUJOS_TOP} color={T.accent2} />
        </ChartCard>

        <ChartCard title={tx("flujos.con_incidencias")} sub={tx("flujos.ultimas_24h")}>
          {DEMO_MAKE_FLUJOS_ERRORES.length > 0
            ? <HorizontalBarChart data={DEMO_MAKE_FLUJOS_ERRORES} color={T.danger} />
            : <div style={{ color:T.accent, textAlign:"center", padding:"20px 0", fontSize:".9rem" }}>{tx("flujos.sin_errores")}</div>
          }
        </ChartCard>

        <ChartCard title={tx("flujos.criticos")} sub={tx("flujos.estado_op")}>
          {[
            { n:"API Reservas", s:"ok" }, { n:"Alta Jugador", s:"ok" }, { n:"Backup Semanal", s:"ok" },
            { n:"Alerta Pistas", s:"ok" }, { n:"NPS Semanal", s:"warn" }, { n:"Recordatorio Pago", s:"error" },
          ].map(f => (
            <div key={f.n} style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"6px 0", borderBottom:`1px solid rgba(255,255,255,.05)` }}>
              <span style={{ color:T.text, fontSize:".8rem" }}>{f.n}</span>
              <FlowStatusBadge status={f.s} />
            </div>
          ))}
        </ChartCard>
      </div>

      {/* TABLA DE FLUJOS COMPLETA (expandible) */}
      <div style={{ borderRadius:20, border:`1px solid rgba(255,255,255,.09)`, background:"rgba(11,17,29,.82)", overflow:"hidden" }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"14px 20px", borderBottom:`1px solid rgba(255,255,255,.07)`, flexWrap:"wrap", gap:10 }}>
          <span style={{ fontWeight:800, fontSize:".9rem" }}>{tx("flujos.todos_flujos")} ({WORKFLOW_ITEMS.length})</span>
          <div style={{ display:"flex", gap:8, flexWrap:"wrap", alignItems:"center" }}>
            {showTable && cats.map(c => (
              <button key={c} type="button" onClick={() => setCatFilter(c)}
                style={{ border:`1px solid ${catFilter===c ? T.accent : "rgba(255,255,255,.12)"}`, background:catFilter===c ? "rgba(182,255,0,.1)" : "none", color:catFilter===c ? T.accent : T.textDim, borderRadius:8, padding:"4px 10px", cursor:"pointer", fontSize:".72rem", fontWeight:700 }}>
                {c}
              </button>
            ))}
            <button type="button" onClick={() => setShowTable(v => !v)}
              style={{ border:`1px solid rgba(182,255,0,.3)`, background:"none", color:T.accent, borderRadius:10, padding:"6px 14px", cursor:"pointer", fontWeight:700, fontSize:".8rem" }}>
              {showTable ? tx("flujos.ocultar_tabla") : tx("flujos.ver_tabla")}
            </button>
          </div>
        </div>
        ...
        {showTable && (
          <div className="cp04-table-wrap">
            <table className="cp04-table">
              <thead>
                <tr><th>#</th><th>{tx("flujos.col_flujo")}</th><th>{tx("flujos.col_categoria")}</th><th>{tx("flujos.col_estado")}</th><th>%</th></tr>
              </thead>
              <tbody>
                {filtered.map(flow => (
                  <tr key={flow.id}>
                    <td>{flow.id}</td>
                    <td>
                      <strong>{flow.nombre_final}</strong>
                      <div style={{ color:T.textDim, fontSize:".78rem", marginTop:4, lineHeight:1.4 }}>{flow.funcion}</div>
                    </td>
                    <td>{flow.categoria}</td>
                    <td><FlowStatusBadge status={flow.make_active ? "ok" : "paused"} /></td>
                    <td><span style={{ color:Number(flow.porcentaje)===100 ? T.accent : T.warning, fontWeight:700 }}>{flow.porcentaje}%</span></td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <div style={{ marginTop:16, color:"rgba(255,255,255,.18)", fontSize:".68rem" }}>
        {tx("flujos.nota_integracion")}
      </div>
    </section>
  );
}
