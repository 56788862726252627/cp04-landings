# Informe de generación — Despacho De Abogados

Business ID: `despacho-de-abogados-demo` · Sector: `law` · Generado: null
...
- Módulos activados (10): autenticacion, clientes, citas, pagos, facturacion, documentos, servicios, profesionales, soporte, configuracion
- Automatizaciones seleccionadas: confirmacion, impago, recordatorio, seguimiento
- Integraciones declaradas: payments
...
- confidencialidad reforzada de documentos de clientes
...
- Riesgo: confidencialidad reforzada de documentos de clientes
- Limitación: Análisis únicamente: pasa --execute para materializar el tenant real.

## Rendimiento
- Duración de la generación: 58 ms
