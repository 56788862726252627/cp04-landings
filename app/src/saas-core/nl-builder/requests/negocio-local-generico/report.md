# Informe de generación — Negocio Local Genérico

Business ID: `negocio-local-generico` · Sector: `generic-local-service` · Generado: null
...
- Módulos activados (7): autenticacion, clientes, citas, servicios, profesionales, soporte, configuracion
- Automatizaciones seleccionadas: confirmacion, recordatorio
- Integraciones declaradas: messaging
...
- Confirmar antes de producción: ¿A qué sector pertenece exactamente el negocio (clínica, despacho, club, restaurante, etc.)?
...
- Revisar supuesto — business.sector: se asumió "generic-local-service" (ningún preset sectorial coincidió; se aplicó el preset genérico de negocio local)
...
## Rendimiento
- Duración de la generación: 54 ms
