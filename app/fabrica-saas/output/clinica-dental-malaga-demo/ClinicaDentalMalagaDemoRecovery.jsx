/**
 * OUTPUT GENERADO · Clínica Dental Málaga Demo · Recuperación de leads
...
import { MOCK_LEADS_ABANDONO } from './ClinicaDentalMalagaDemoMockData.js';
...
export function ClinicaDentalMalagaDemoRecovery() {
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <p style={{ margin: '0 0 16px', fontSize: 12, color: '#6b7280' }}>
        Clínica Dental Málaga Demo · {pendientes.length} leads pendientes · {recuperados.length} recuperados
      </p>
