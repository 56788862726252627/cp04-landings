/**
 * OUTPUT GENERADO · Clínica Dental Aurora (Demo) · Chatbot IA simulado
...
import { MOCK_SEDES, MOCK_PROFESIONALES, MOCK_SLOTS } from './ClinicaDentalAuroraDemoMockData.js';
...
export function ClinicaDentalAuroraDemoChatbot() {
    ...
    <div style={{ padding: 20 }}>
      ...
      <div style={BOX}>
        ...
        {step === 'servicio' && (
          <>
            <BotBubble icon="🦷">
              ¡Hola! Soy el asistente virtual de <strong>Clínica Dental Aurora (Demo)</strong>.<br />
