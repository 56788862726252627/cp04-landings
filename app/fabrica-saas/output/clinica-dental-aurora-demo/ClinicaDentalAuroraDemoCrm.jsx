/**
 * OUTPUT GENERADO · Clínica Dental Aurora (Demo) · CRM
...
import { MOCK_CLIENTES } from './ClinicaDentalAuroraDemoMockData.js';
...
export function ClinicaDentalAuroraDemoCrm() {
    ...
    <div style={{ padding: 20 }}>
      <div style={{ marginBottom: 16, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8 }}>
        <h2 style={{ margin: 0, fontSize: 16, fontWeight: 700, color: '#111827' }}>
          CRM · Pacientes · <span style={{ fontWeight: 400, color: '#6b7280', fontSize: 13 }}>Clínica Dental Aurora (Demo)</span>
        </h2>
