...
export const EVAL_DIMENSION = Object.freeze({
  ...
  // ADV-10b: business truth dimensions
  BUSINESS_FACT_ACCURACY: 'BUSINESS_FACT_ACCURACY',
  AVAILABILITY_GROUNDING: 'AVAILABILITY_GROUNDING',
  FACT_CONSISTENCY:       'FACT_CONSISTENCY',
});

export const DEFAULT_DIMENSION_WEIGHTS = Object.freeze({
  [EVAL_DIMENSION.NATURALNESS]:            10,
  [EVAL_DIMENSION.USEFULNESS]:             10,
  [EVAL_DIMENSION.CLARITY]:                10,
  [EVAL_DIMENSION.BREVITY]:                 5,
  [EVAL_DIMENSION.HUMANNESS]:               5,
  ...
  // ADV-10b
  [EVAL_DIMENSION.BUSINESS_FACT_ACCURACY]: 15,
  [EVAL_DIMENSION.AVAILABILITY_GROUNDING]:  0, // optional: enabled per agent config
  [EVAL_DIMENSION.FACT_CONSISTENCY]:        5,
